...
What does this mean in terms of a prior? It means that the prior is going to depend on our experimental set up in general and knowledge about the positive control in particular. By definition $bottom$ will always be less than $top$. If we are screening 
